            ...
            <div>
                ...
                <form class="w-full" action="{{ route('food.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        ...
                        <p class="text-gray-600 text-xs italic">Dipisahkan dengan koma, contoh: Timun, Bawang merah, Bawang putih </p>
                        </div>
                        <div class="w-full px-3">
                            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-last-name">
                                Price
                        ...
                        <p class="text-gray-600 text-xs italic">Dipisahkan dengan koma, contoh: Recommended, Popular, New Food </p>
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
