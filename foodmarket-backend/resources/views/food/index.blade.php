<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-10">
                <a href="{{ route('food.create') }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-5 rounded">
                    + Create Food
                </a>
            </div>
            <div class="bg-white">
                <table class="table-auto w-full">
                    <thead>
                        <tr>
                            <th class="border pex-6 py-4">ID</th>
                            <th class="border pex-6 py-4">Name</th>
                            <th class="border pex-6 py-4">Price</th>
                            <th class="border pex-6 py-4">Rate</th>
                            <th class="border pex-6 py-4">Types</th>
                            <th class="border pex-6 py-4">Action</th>
                        </tr>
                    </thead>
                    <tbody>
