                ...
                <table class="table-auto w-full">
                    <thead>
                        <tr>
                            ...
                            <th class="border pex-6 py-4">Food</th>
                            <th class="border pex-6 py-4">User</th>
                            <th class="border pex-6 py-4">Quantity</th>
                            <th class="border pex-6 py-4">Total</th>
                            <th class="border pex-6 py-4">Status</th>
